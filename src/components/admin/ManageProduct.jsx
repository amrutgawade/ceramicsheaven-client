...
function ManageProduct({ title }) {
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 md:px-0">
      <h2 className="text-gray-800 mb-4 text-xl font-bold sm:text-2xl">{title}</h2>
      <div className="flex flex-col justify-center bg-white shadow">
        ...
        <div className="flex flex-col gap-5 p-7">
          ...
          {inputList.map((data, i) => {
            return (
              <div className="flex items-center justify-between gap-x-5 mt-4" key={i}>
                <div>
                  <label
                    htmlFor="width"
                    className="block mb-3 text-black dark:text-white"
